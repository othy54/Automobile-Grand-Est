...
<div class="container mb-5" style="padding-top: 150px;">
    ...
    <h1 style="font-size: 10vw; font-weight: bold">REPRISE</h1>
    <hr>
    <h5 style="text-align: center">Renseignez les détails et nous ferons de notre mieux pour examiner votre proposition.</h5>
    <br>
