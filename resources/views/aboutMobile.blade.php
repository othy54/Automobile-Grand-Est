...
<div class="container" style="padding-top: 150px;">
    ...
    <h1 style="font-size: 10vw; font-weight: bold">L'ENTREPRISE</h1>
    <hr>

    <div class="container" style="padding-left: 40px; padding-right: 40px; font-size: 20px; text-align:justify">
