...
class SearchVehicleCatalogueController extends Controller
{
    ...
    public function index() {
        ...
        $brands = Vehicles::select('brand')->distinct()->get();
        $vehicles = Vehicles::orderBy('id', 'desc')->get();
        $images = Images::orderBy('vehicles_id', 'desc')->select('imageName', 'vehicles_id')->where('imageNumber', '1')->get();
    ...
    public function search() {
        ...
        $query = Vehicles::orderBy('id', 'desc');
